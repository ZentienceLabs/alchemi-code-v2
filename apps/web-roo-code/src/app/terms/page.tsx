			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Alchemi Code Cloud Terms of Service
					</h1>
					...
					<ul className="lead">
						<li>
							...
							executed by Alchemi Code and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Alchemi Code and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Alchemi Code maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Alchemi Code <strong>does not</strong> use Customer Content to train, fine-tune,
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Alchemi Code may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Alchemi Code offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						...
						) explains how Alchemi Code collects and handles personal information. If Customer requires a
						DPA, email{" "}
					...
					<ol>
						...
						<li>
							...
							<br />
							Alchemi Code may update these TOS by posting a revised version at the same URL and emailing
							or in-app notifying Customer at least 30 days before changes take effect. Continued use
