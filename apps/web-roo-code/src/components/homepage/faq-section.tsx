...
const faqs: FAQItem[] = [
	...
	{
		question: "How does Alchemi Code differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Alchemi Code is <strong>open-source and fully customizable</strong>, letting you integrate any AI model
				...
				Alchemi Code is <strong>permission-based</strong>, meaning you can control and approve any file changes
				or command executions.
			</>
		),
	},
	{
		question: "Is Alchemi Code really free?",
		answer: (
			<>
				Yes! Alchemi Code is completely free and open-source. You&apos;ll only pay for the AI model usage if you
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because Alchemi Code is an extension in your local VS Code, your code never leaves your machine
				unless you connect to an external AI API. Even then, you control exactly what is sent to the AI model.
				You can use tools like .rooignore to exclude sensitive files, and you can also run Alchemi Code with
				offline/local models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does Alchemi Code support?",
		answer: (
			<>
	...
	{
		question: "Does Alchemi Code support my programming language?",
		answer: (
			<>
				Likely yes! Alchemi Code supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Alchemi Code uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Alchemi Code for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Alchemi Code was built for enterprise environments. You can self-host AI models or use your own
				trusted provider. All file changes and commands go through permission gating, so nothing runs without
				your approval. And because Alchemi Code is fully open-source, it&apos;s auditable—you can review exactly
	...
	},
	{
		...
		answer: (
			<>
				Alchemi Code shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about Alchemi Code and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
