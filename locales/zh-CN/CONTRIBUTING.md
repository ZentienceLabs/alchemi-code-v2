...
Alchemi Code 是一个由社区驱动的项目，我们高度重视每一份贡献。为了简化协作流程，我们采用 [Issue-First](#issue-first-方式) 原则，这意味着所有 [Pull Request (PR)](#提交-pull-request) 必须首先关联到 GitHub Issue。请仔细阅读本指南。
...
- 文档相关，请访问 [Alchemi Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs)。
...
提交贡献即表示你同意你的贡献将基于 Apache 2.0 许可证，与 Alchemi Code 的许可一致。
