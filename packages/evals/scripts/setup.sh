...
build_extension() {
  echo "🔨 Building the Alchemi Code extension..."
...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "The Alchemi Code evals system can also be run with Docker on any platform."
...
echo -n "🗄️ Syncing Alchemi Code evals database... "
...
read -p "💻 Do you want to build a new version of the Alchemi Code extension? [currently $current_version] (y/N): " build_extension
