 ...
 *
 * This class manages the state for the marketplace view in the Alchemi Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Alchemi Code extensions interface
